...
const Home = ()=>{
    return(
        <section className="w-3/4 m-auto my-10">
            ...
            <img src={dashbord} alt="Mailman(Postman) is sending mail." className="lg:w-[55%] sm:w-full my-5 rounded-lg shadow-[0_0_35px_-8px_rgba(0,0,0,0.6)] shadow-amber-900 m-auto" />
        </section>
    );
}
